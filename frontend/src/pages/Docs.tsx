...
const resources: DocSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { heading: "Presenton + Zoom", body: "Self-host Presenton (Docker), set PRESENTON_BASE_URL. Companion Present Deck → Generate deck saves PPTX under Documents. Zoom: ZOOM_DESKTOP_PATH or ZOOM_DEFAULT_JOIN_URL — Mentrix opens Zoom; you join and share PowerPoint. Electron Present all slides: speaker notes → F5 → narrate → Right Arrow (Stop cancels)." },
